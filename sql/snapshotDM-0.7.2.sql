...
INSERT INTO stObservingModes(name, description) VALUES 
...
CREATE TABLE ScanComments (
  ...
  DjangoUsers_id INTEGER UNSIGNED NOT NULL,
  extra_comment TEXT NULL,
  PRIMARY KEY(id),
  INDEX ObsComment_FKIndex1(DjangoUsers_id),
  INDEX ObsComment_FKIndex2(stPredefinedComments_id),
  INDEX ObsComment_FKIndex3(Scans_id),
  FOREIGN KEY(DjangoUsers_id)
    REFERENCES DjangoUsers(id)
      ON DELETE RESTRICT
      ON UPDATE CASCADE,
